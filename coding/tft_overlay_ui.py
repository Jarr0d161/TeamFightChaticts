...
class TwitchBotGUI(tk.Frame):
    def __init__(self, parent: tk.Tk, width=518, height=180, *args, **kwargs):
        ...
        self.GLabel_256["text"] = self.ui_settings["256"]
        ...
        self.GLabel_253["text"] = self.ui_settings["253"]
        ...
        self.GLabel_459["text"] = self.ui_settings["459"]
